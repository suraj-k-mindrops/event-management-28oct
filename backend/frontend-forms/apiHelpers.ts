...
// TODO: Update this line based on your framework
// For Vite: const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000/api';
// For React: const API_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'http://localhost:5000/api';

// @ts-ignore - Vite uses import.meta.env
// @ts-ignore - React uses process.env
const API_BASE_URL = (typeof import !== 'undefined' && (import.meta as any).env?.VITE_API_BASE_URL) || 
